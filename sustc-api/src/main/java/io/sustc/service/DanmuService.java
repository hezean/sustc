...
public interface DanmuService {
     ...
     * It is mandatory that the a user shall watch the video first before he/she can send danmu to it.
     *
     ...
     * Similar to bilibili's mechanism, user can choose to only display part of the danmus to have a better watching experience.
     *
     * @param bv        the video's bv
     ...
     * <ul>
     * <li>{@code bv} is invalid (null or empty or not found)</li>
     * <li>{@code timeStart} and/or {@code timeEnd} is invalid ({@code timeStart} <= {@code timeEnd} or any of them < 0 or > video duration)</li>
     ...
     * It is mandatory that the a user shall watch the video first before he/she can like a danmu of it.
     *
     * @param auth the current user's authentication information
